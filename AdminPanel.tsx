          ...
          <form onSubmit={handleSettingsSave} className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-gray-50 p-6 rounded-xl border-2 border-gray-200 space-y-4">
                <h4 className="font-black text-[#ff0000] uppercase text-sm mb-2">Site Identity</h4>
                <div>
                  <label className="block text-[10px] font-black uppercase mb-1">Website Name (Displayed at Top)</label>
                ...
                <div>
                  <label className="block text-[10px] font-black uppercase mb-1">Footer Text / Domain Display</label>
                  <input type="text" className="w-full p-3 border-2 rounded font-bold" value={settingsForm.footerText} onChange={(e) => setSettingsForm({...settingsForm, footerText: e.target.value})} />
                </div>
              </div>

              <div className="bg-gray-50 p-6 rounded-xl border-2 border-gray-200 space-y-4">
                <h4 className="font-black text-[#24A1DE] uppercase text-sm mb-2">Social Links</h4>
                <div>
                  <label className="block text-[10px] font-black uppercase mb-1">Telegram Group Link</label>
            ...
            <button type="submit" className="w-full py-4 bg-green-600 text-white font-black rounded-lg uppercase shadow-xl">Save Website Settings</button>
          </form>
        )}
